...
<header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-#8E8D8A" style="float: right;height: inherit;margin-right: 3em;" >
            ...
            <div class="table table-hover">
                    ...
                    <tr>
                      <h1 style="color: black; font-weight: bold;font-family: serif"> <c:out value="${item.title}"></c:out> </h1>
                        ...
                        <tr>
                            <h4 style="font-weight: lighter ;font-family: serif"><i> Yayınlanma Tarihi : <c:out value="${item.date}"></c:out> </i></h4>
                        </tr>
