    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <form action="blog-detail" method="post">
                ...
                <div class="mb-3">
                    <h1 style="color: black; font-weight: bold ;font-family: serif;font-size: 50px"><%=blog.getTitle()%></h1>
                </div>

                <div class="mb-3">
                    <h3 style="color: black;font-weight: normal;font-family: serif;font-size: 40px"><%=blog.getDescription()%></h3>
                </div>

                <div class="mb-3">
                    <h4 style="color: black;font-weight: lighter ;font-family: serif; font-size: 20px"><i><%=blog.getDetail()%></i></h4>
                </div>
